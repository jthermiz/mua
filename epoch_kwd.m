...
%create a trial structure from data found in a .kwd file using time trial information in 'stim'
%'stim' has 3 fields: 'atime' = an array of sample index where trial onset occurs in .kwd file; 
%'typename' = a cell array of the trial kind or type name'; and 'type' an array of type name indices
%Example:
    % stim.atime = [10 100 190];
    % stim.type = [1 1 2];
    % stim.typename = {'left,'right'};
